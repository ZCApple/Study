//
//  UICollectionViewCustomFlowLayout.swift
//  StudyProject
//
...
@objc protocol UICollectionViewCustomFlowLayoutDelegate {
    // cell 大小
...
class UICollectionViewCustomFlowLayout: UICollectionViewLayout {
    ...
    weak var delegate: UICollectionViewCustomFlowLayoutDelegate?
    ...
    override func prepare() {
        ...
        for sectionIndex in 0..<collectionView.numberOfSections {
            ...
            if let headerLayoutAttribute = getSupplementaryViewLayoutAttribute(ofKind: UICollectionView.elementKindSectionHeader, at: sectionIndexPath) {
            ...
            // 获取该组的底部视图布局
            if let footerLayoutAttribute = getSupplementaryViewLayoutAttribute(ofKind: UICollectionView.elementKindSectionFooter, at: sectionIndexPath) {
